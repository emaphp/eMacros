...
class ArrayPackageTest extends eMacrosTest {
	...
	public function testCar1() {
		$program = new Program('(car null)');
		$result = $program->execute(self::$env);
	}
	
	public function testCar2() {
		$program = new Program('(car (array))');
		$result = $program->execute(self::$env);
		$this->assertNull($result);
	}
	
	public function testCar3() {
		$program = new Program('(car (array null))');
		$result = $program->execute(self::$env);
		$this->assertNull($result);
	}
	
	public function testCar4() {
		$program = new Program('(car (range 1 10))');
		$result = $program->execute(self::$env);
		$this->assertEquals(1, $result);
	}
	
	public function testCar5() {
		$program = new Program('(car (%0))');
	...
	public function testCar7() {
		$program = new Program('(Array::car (%0))');
		$result = $program->execute(self::$env, new \ArrayObject(array(2)));
		$this->assertEquals(2, $result);
	}
	...
	public function testCdr1() {
		$program = new Program('(cdr null)');
		$result = $program->execute(self::$env);
	}
	
	public function testCdr2() {
		$program = new Program('(cdr (array))');
		$result = $program->execute(self::$env);
		$this->assertNull($result);
	}
	
	public function testCdr3() {
		$program = new Program('(cdr (array null))');
		$result = $program->execute(self::$env);
		$this->assertEquals(array(), $result);
	}
	
	public function testCdr4() {
		$program = new Program('(cdr (array 1 2 3))');
		$result = $program->execute(self::$env);
		$this->assertEquals(array(2, 3), $result);
	}
	
	public function testCdr5() {
		$program = new Program('(cdr (%0))');
		$result = $program->execute(self::$env, new \ArrayObject(array()));
		$this->assertEquals(null, $result);
	}
	...
	public function testCdr8() {
		$program = new Program('(Array::cdr (%0))');
		$result = $program->execute(self::$env, new \ArrayObject(array(1, 2, 3)));
		$this->assertEquals(array(2, 3), $result);
	}
	...
	public function testIn0() {
		$program = new Program('(in 1 (array 1 2 3))');
		$result = $program->execute(self::$env);
		$this->assertEquals(true, $result);
	}
	
	public function testIn1() {
		$program = new Program('(in 4 (array 1 2 3))');
		$result = $program->execute(self::$env);
		$this->assertEquals(false, $result);
	}
	
	public function testIn2() {
		$program = new Program('(Array::in 4 (array 1 2 3))');
		$result = $program->execute(self::$env);
		$this->assertEquals(false, $result);
	}
	
	public function testCount1() {
		$program = new Program('(count (array 1 2 3))');
		$result = $program->execute(self::$env);
		$this->assertEquals(3, $result);
	}
	
	public function testCount2() {
		$program = new Program('(Array::count (array 1 2 3))');
		$result = $program->execute(self::$env);
		$this->assertEquals(3, $result);
	}
	
	public function testRange1() {
		$program = new Program('(range 1 10)');
		$result = $program->execute(self::$env);
		$this->assertEquals(range(1, 10), $result);
	}
	
	public function testRange2() {
		$program = new Program('(Array::range 1 10)');
		$result = $program->execute(self::$env);
		$this->assertEquals(range(1, 10), $result);
	}
	
	public function testChunk1() {
		$program = new Program('(chunk (array "a" "b" "c" "d" "e") 2)');
		$result = $program->execute(self::$env);
		$this->assertEquals(array_chunk(array('a', 'b', 'c', 'd', 'e'), 2), $result);
	}
	
	public function testChunk2() {
		$program = new Program('(Array::chunk (array "a" "b" "c" "d" "e") 2)');
		$result = $program->execute(self::$env);
		$this->assertEquals(array_chunk(array('a', 'b', 'c', 'd', 'e'), 2), $result);
	}
	
	public function testCombine1() {
		$program = new Program('(combine (array "green" "red" "yellow") (array "avocado" "apple" "banana"))');
		$result = $program->execute(self::$env);
		$this->assertEquals(array_combine(array('green', 'red', 'yellow'), array('avocado', 'apple', 'banana')), $result);
	}
	
	public function testCombine2() {
		$program = new Program('(Array::combine (array "green" "red" "yellow") (array "avocado" "apple" "banana"))');
		$result = $program->execute(self::$env);
		$this->assertEquals(array_combine(array('green', 'red', 'yellow'), array('avocado', 'apple', 'banana')), $result);
	}
	
	public function testCountValues1() {
		$program = new Program('(count-values (array 1 "hello" 1 "world" "hello"))');
		$result = $program->execute(self::$env);
		$this->assertEquals(array_count_values(array(1, "hello", 1, "world", "hello")), $result);
	}
	
	public function testCountValues2() {
		$program = new Program('(Array::count-values (array 1 "hello" 1 "world" "hello"))');
		$result = $program->execute(self::$env);
		$this->assertEquals(array_count_values(array(1, "hello", 1, "world", "hello")), $result);
	}
	
	public function testDiff1() {
		$program = new Program('(diff (array "red" "blue" "red") (array "yellow" "red"))');
		$result = $program->execute(self::$env);
		$this->assertEquals(array_diff(array("red", "blue", "red"), array("yellow", "red")), $result);
	}
	
	public function testDiff2() {
		$program = new Program('(Array::diff (array "red" "blue" "red") (Core::array "yellow" "red"))');
		$result = $program->execute(self::$env);
		$this->assertEquals(array_diff(array("red", "blue", "red"), array("yellow", "red")), $result);
	}
	
	public function testFill1() {
		$program = new Program('(fill -2 4 "pear")');
		$result = $program->execute(self::$env);
		$this->assertEquals(array_fill(-2, 4, 'pear'), $result);
	}
	
	public function testFill2() {
		$program = new Program('(Array::fill -2 4 "pear")');
		$result = $program->execute(self::$env);
		$this->assertEquals(array_fill(-2, 4, 'pear'), $result);
	}
	
	public function testFilter1() {
		$program = new Program('(filter (array 1 2 3 4) (%0))');
	...
	public function testFilter3() {
		$program = new Program('(Array::filter (array 1 2 3 4) (%0))');
		$result = $program->execute(self::$env, array('Test\\ArrayTest', 'odd'));
		$this->assertEquals(array(1, 2 => 3), $result);
	}
	...
	public function testFlip2() {
		$arg = array("a" => 1, "b" => 1, "c" => 2);
		$program = new Program('(Array::flip (%0))');
		$result = $program->execute(self::$env, $arg);
		$this->assertEquals(array_flip($arg), $result);
	}
	...
	public function testIntersect1() {
		...
		$program = new Program('(intersect (%0) (%1))');
	...
	public function testIntersect2() {
		$array1 = array("a" => "green", "red", "blue");
		$array2 = array("b" => "green", "yellow", "red");
		$program = new Program('(Array::intersect (%0) (%1))');
		$result = $program->execute(self::$env, $array1, $array2);
		$this->assertEquals(array_intersect($array1, $array2), $result);
	}
	...
	public function testKeys2() {
		$arg = array(0 => 100, "color" => "red");
		$program = new Program('(Array::keys (%0))');
		$result = $program->execute(self::$env, $arg);
		$this->assertEquals(array_keys($arg), $result);
	}
	...
	public function testMerge2() {
		$array1 = array("color" => "red", 2, 4);
		$array2 = array("a", "b", "color" => "green", "shape" => "trapezoid", 4);
		$program = new Program('(Array::merge (%0) (%1))');
		$result = $program->execute(self::$env, $array1, $array2);
		$this->assertEquals(array_merge($array1, $array2), $result);
	}
	...
	public function testSearch1() {
		...
		$program = new Program('(search "green" (%0))');
	...
	public function testSearch2() {
		$array = array(0 => 'blue', 1 => 'red', 2 => 'green', 3 => 'red');
		$program = new Program('(Array::search "green" (%0))');
		$result = $program->execute(self::$env, $array);
		$this->assertEquals(array_search("green", $array), $result);
	}
	...
	public function testSlice1() {
		$arg = array("a", "b", "c", "d", "e");
		$program = new Program('(slice (%0) 0 3)');
		$result = $program->execute(self::$env, $arg);
	...
	public function testSlice2() {
		$arg = array("a", "b", "c", "d", "e");
		$program = new Program('(Array::slice (%0) 0 3)');
		$result = $program->execute(self::$env, $arg);
		$this->assertEquals(array_slice($arg, 0, 3), $result);
	}
	
	public function testPad1() {
		$program = new Program('(Array::pad (array 12 10 9) -7 -1)');
		$result = $program->execute(self::$env);
	...
	public function testPad2() {
		$program = new Program('(pad (array 12 10 9) -7 -1)');
		$result = $program->execute(self::$env);
		$this->assertEquals(array_pad(array(12, 10, 9), -7, -1), $result);
	}
	
	public function testRand1() {
		$program = new Program('(rand (array 1 2 3 4 5) 2)');
		$result = $program->execute(self::$env);
		$this->assertEquals(2, count($result));
	}
	
	public function testRand2() {
		$program = new Program('(Array::rand (array 1 2 3 4 5) 2)');
		$result = $program->execute(self::$env);
		$this->assertEquals(2, count($result));
	}
	...
	public function testProduct2() {
		$input = array(2, 4, 6, 8);
		$program = new Program('(Array::product (%0))');
		$result = $program->execute(self::$env, $input);
		$this->assertEquals(array_product($input), $result);
	}
	...
	public function testSum2() {
		$a = array(2, 4, 6, 8);
		$program = new Program('(Array::sum (%0))');
		$result = $program->execute(self::$env, $a);
		$this->assertEquals(array_sum($a), $result);
	}
	...
	public function testUnique1() {
		...
		$program = new Program('(unique (%0) SORT_STRING)');
		$result = $program->execute(self::$env, $input);
	...
	public function testUnique2() {
		$input = array("a" => "green", "red", "b" => "green", "blue", "red");
		$program = new Program('(Array::unique (%0) SORT_STRING)');
		$result = $program->execute(self::$env, $input);
		$this->assertEquals(array_unique($input, SORT_STRING), $result);
	}
	...
	public function testValues2() {
		$array = array("size" => "XL", "color" => "gold");
		$program = new Program('(Array::values (%0))');
		$result = $program->execute(self::$env, $array);
		$this->assertEquals(array_values($array), $result);
	}
	...
	public function testReplace1() {
		...
		$program = new Program('(Array::replace (%0) (%1))');
	...
	public function testReverse1() {
		...
		$program = new Program('(Array::reverse (%0))');
		$result = $program->execute(self::$env, $input);
	...
	public function testArrayPop1() {
		$program = new Program('(pop 3)');
		$result = $program->execute(self::$env);
	}
	
	public function testArrayPop2() {
		$program = new Program('(:= _arr (array 1 2 3))(pop _arr)');
		$result = $program->execute(self::$env);
		$this->assertEquals(3, $result);
	}
	
	public function testArrayPop3() {
		$program = new Program('(:= _arr (array 1 2 3))(pop _arr)(<- _arr)');
		$result = $program->execute(self::$env);
		$this->assertEquals(array(1, 2), $result);
	}
	
	public function testArrayPop4() {
		$program = new Program('(:= _arr (array))(pop _arr)');
		$result = $program->execute(self::$env);
		$this->assertEquals(null, $result);
	}
	
	public function testArrayPop5() {
		$program = new Program('(:= _arr (array 1 2 3))(Array::pop _arr)(<- _arr)');
		$result = $program->execute(self::$env);
		$this->assertEquals(array(1, 2), $result);
	}
	
	public function testArrayPop6() {
		$program = new Program('(:= _arr (%0))(Array::pop _arr)(<- _arr)');
	...
	public function testArrayPop7() {
		$program = new Program('(:= _arr (%0))(Array::pop _arr)');
		$result = $program->execute(self::$env, new Fizz(array(1, 2, 3)));
		$this->assertEquals(3, $result);
	}
	...
	public function testArrayMap1() {
		$program = new Program('(map "strtoupper")');
		$result = $program->execute(self::$env);
	}
	...
	public function testArrayMap2() {
		$program = new Program('(map null (array))');
		$result = $program->execute(self::$env);
	}
	
	public function testArrayMap3() {
		$program = new Program('(map "strtoupper" (array "a" "b" "c"))');
		$result = $program->execute(self::$env);
		$this->assertEquals(array("A", "B", "C"), $result);
	}
	
	public function testArrayMap4() {
		$program = new Program('(map (%0) (array 1 2 3))');
	...
	public function testArrayMap5() {
		$program = new Program('(map (%0) (array 1 2 3) (array "uno" "dos" "tres"))');
	...
	public function testArrayMap6() {
		$program = new Program('(Array::map "strtoupper" (array "a" "b" "c"))');
		$result = $program->execute(self::$env);
		$this->assertEquals(array("A", "B", "C"), $result);
	}
	
	public function testArrayMap7() {
		$program = new Program('(map String::reverse (array "abc" "def" "hij"))');
		$result = $program->execute(self::$env);
		$this->assertEquals(array("cba", "fed", "jih"), $result);
	}
	
	public function testArrayMap8() {
		$program = new Program('(map String::reverse (%0))');
	...
	public function testArrayWalk2() {
		$program = new Program('(walk "strtoupper" null)');
		$result = $program->execute(self::$env);
	}
	
	public function testArrayWalk3() {
		$program = new Program('(:= _arr (array "one" "two" "three"))(walk _arr (%0))(<- _arr)');
	...
	public function testArrayWalk5() {
		$program = new Program('(:= _arr (array "orange" "apple" "banana"))(walk _arr (%0) "FRUIT: ")(<- _arr)');
	...
	public function testArrayWalk6() {
		$program = new Program('(:= _arr (%0))(walk _arr (%1))(<- _arr)');
	...
	public function testArrayPush2() {
		$program = new Program('(push null 1)');
		$result = $program->execute(self::$env);
	}
	
	public function testArrayPush3() {
		$program = new Program('(:= _arr (array))(push _arr 1)');
		$result = $program->execute(self::$env);
		$this->assertEquals(1, $result);
	}
	
	public function testArrayPush4() {
		$program = new Program('(:= _arr (array))(push _arr 10)(<- _arr)');
		$result = $program->execute(self::$env);
		$this->assertEquals(array(10), $result);
	}
	
	public function testArrayPush5() {
		$program = new Program('(:= _arr (array 10))(push _arr 20 30)');
		$result = $program->execute(self::$env);
		$this->assertEquals(3, $result);
	}
	
	public function testArrayPush6() {
		$program = new Program('(:= _arr (array 10))(push _arr 20 30)(<- _arr)');
		$result = $program->execute(self::$env);
		$this->assertEquals(array(10, 20, 30), $result);
	}
	
	public function testArrayPush7() {
		$program = new Program('(:= _arr (%0))(push _arr 20 30)');
		$result = $program->execute(self::$env, new Fizz(array(10)));
		$this->assertEquals(3, $result);
	}
	
	public function testArrayPush9() {
		$program = new Program('(:= _arr (%0))(push _arr 20 30)(<- _arr)');
		$result = $program->execute(self::$env, new Fizz(array(10)));
	...
	public function testArrayShif0() {
		$program = new Program('(shift)');
		$result = $program->execute(self::$env);
	}
	
	public function testArrayShift1() {
		$program = new Program('(shift null)');
		$result = $program->execute(self::$env);
		$this->assertNull($result);
	}
	
	public function testArrayShift2() {
		$program = new Program('(:= _arr (array))(shift _arr)');
		$result = $program->execute(self::$env);
		$this->assertNull($result);
	}
	
	public function testArrayShift3() {
		$program = new Program('(:= _arr (array 10 20 30))(shift _arr)');
		$result = $program->execute(self::$env);
		$this->assertEquals(10, $result);
	}
	
	public function testArrayShift4() {
		$program = new Program('(:= _arr (array 10 20 30))(shift _arr)(<- _arr)');
		$result = $program->execute(self::$env);
		$this->assertEquals(array(20, 30), $result);
	}
	
	public function testArrayShift5() {
		$program = new Program('(:= _arr (%0))(shift _arr)');
	...
	public function testArrayUnshift1() {
		$program = new Program('(unshift null)');
		$result = $program->execute(self::$env);
	}
	...
	public function testArrayUnshift2() {
		$program = new Program('(unshift null 1)');
		$result = $program->execute(self::$env);
	}
	
	public function testArrayUnshift3() {
		$program = new Program('(:= _arr (array))(unshift _arr 1)');
		$result = $program->execute(self::$env);
		$this->assertEquals(1, $result);
	}
	
	public function testArrayUnshift4() {
		$program = new Program('(:= _arr (array))(unshift _arr 10)(<- _arr)');
		$result = $program->execute(self::$env);
		$this->assertEquals(array(10), $result);
	}
	
	public function testArrayUnshift5() {
		$program = new Program('(:= _arr (array 10))(unshift _arr 20 30)');
		$result = $program->execute(self::$env);
		$this->assertEquals(3, $result);
	}
	
	public function testArrayUnshift6() {
		$program = new Program('(:= _arr (array "orange" "banana"))(unshift _arr "apple" "raspberry")(<- _arr)');
		$result = $program->execute(self::$env);
		$this->assertEquals(array('apple', 'raspberry', 'orange', 'banana'), $result);
	}
	
	public function testArrayUnshift7() {
		$program = new Program('(:= _arr (%0))(unshift _arr 20 30)');
		$result = $program->execute(self::$env, new Fizz(array(10)));
		$this->assertEquals(3, $result);
	}
	
	public function testArrayUnshift8() {
		$program = new Program('(:= _arr (%0))(unshift _arr 20 30)(<- _arr)');
		$result = $program->execute(self::$env, new Fizz(array(10)));
		$this->assertEquals(new Fizz(array(20, 30, 10)), $result);
	}
	
	public function testArrayReduce1() {
		$program = new Program('(:= _arr (array 1 2 3 4 5))(reduce _arr (%0))');
		$result = $program->execute(self::$env, array('Test\\ArrayTest', 'rsum'));
		$this->assertEquals(15, $result);
	}
	
	public function testArrayReduce2() {
		$program = new Program('(:= _arr (array 1 2 3 4 5))(Array::reduce _arr (%0))');
	...
	public function testArrayReduce3() {
		$program = new Program('(:= _arr (array))(Array::reduce _arr (%0) "No data")');
		$result = $program->execute(self::$env, function (&$v, $w) {
			$v = ($v == 0) ? $w : $v * $w;
			return $v;
		});
	...
	public function testArrayShuffle0() {
		$program = new Program('(Array::shuffle)');
		$result = $program->execute(self::$env);
	}
	...
	public function testArrayShuffle1() {
		$program = new Program('(Array::shuffle null)');
		$result = $program->execute(self::$env);
	}
	
	public function testArrayShuffle2() {
		$program = new Program('(:= _arr (array))(Array::shuffle _arr)');
		$result = $program->execute(self::$env);
		$this->assertTrue($result);
	}
	
	public function testArrayShuffle3() {
		$program = new Program('(:= _arr (array 1 2 3))(Array::shuffle _arr)(<- _arr)');
		$result = $program->execute(self::$env);
	...
	public function testArrayShuffle4() {
		$program = new Program('(:= _arr (%0))(Array::shuffle _arr)(<- _arr)');
		$result = $program->execute(self::$env, new Fizz(array(1, 2, 3)));
	...
	public function testArraySort0() {
		$program = new Program('(Array::sort)');
		$result = $program->execute(self::$env);
	}
	
	public function testArraySort1() {
		$program = new Program('(:= _arr (array "lemon" "orange" "banana" "apple"))(Array::sort _arr)');
		$result = $program->execute(self::$env);
		$this->assertTrue($result);
	}
	
	public function testArraySort2() {
		$program = new Program('(:= _arr (array "lemon" "orange" "banana" "apple"))(Array::sort _arr)(<- _arr)');
		$result = $program->execute(self::$env);
	...
	public function testArraySort3() {
		$program = new Program('(:= _arr (array "Orange1" "orange2" "orange20" "Orange3"))(Array::sort _arr (| Array::SORT_NATURAL Array::SORT_FLAG_CASE))(<- _arr)');
		$result = $program->execute(self::$env);
	...
	public function testArrayRSort1() {
		$program = new Program('(:= _arr (array "lemon" "orange" "banana" "apple"))(Array::rsort _arr)(<- _arr)');
		$result = $program->execute(self::$env);
	...
	public function testArrayASort1() {
		$program = new Program('(:= _arr (array ("d" "lemon") ("a" "orange") ("b" "banana") ("c" "apple")))(Array::asort _arr)(<- _arr)');
		$result = $program->execute(self::$env);
	...
	public function testArrayARSort1() {
		$program = new Program('(:= _arr (array ("d" "lemon") ("a" "orange") ("b" "banana") ("c" "apple")))(Array::arsort _arr)(<- _arr)');
		$result = $program->execute(self::$env);
	...
	public function testArrayKSort1() {
		$program = new Program('(:= _arr (array ("d" "lemon") ("a" "orange") ("b" "banana") ("c" "apple")))(Array::ksort _arr)(<- _arr)');
		$result = $program->execute(self::$env);
		$this->assertEquals(array('a' => 'orange', 'd' => 'lemon', 'b' => 'banana', 'c' => 'apple'), $result);
		$this->assertEquals('orange', current($result));
		$this->assertEquals('a', key($result));
	...
	public function testArrayKRSort1() {
		$program = new Program('(:= _arr (array ("d" "lemon") ("a" "orange") ("b" "banana") ("c" "apple")))(Array::krsort _arr)(<- _arr)');
		$result = $program->execute(self::$env);
		$this->assertEquals(array('a' => 'orange', 'd' => 'lemon', 'b' => 'banana', 'c' => 'apple'), $result);
	...
	public function testUSort1() {
		$program = new Program('(:= _arr (array 3 2 5 6 1))(Array::usort _arr)');
		$result = $program->execute(self::$env);
	}
	
	public function testUSort2() {
		$program = new Program('(:= _arr (array 3 2 5 6 1))(Array::usort _arr (%0))(<- _arr)');
	...
	public function testUASort() {
		$program = new Program('(:= _arr (array ("a" 4) ("b" 8) ("c" -1) ("d" -9) ("e" 2) ("f" 5) ("g" 3) ("h" -4)))(Array::uasort _arr (%0))(<- _arr)');
		$result = $program->execute(self::$env, function ($a, $b) {
			if ($a == $b) {
				return 0;
			}
	...
	public function testUKSort() {
		$program = new Program('(:= _arr (array ("John" 1) ("the Earth" 2) ("an apple" 3) ("a banana" 4)))(Array::uksort _arr (%0))(<- _arr)');
		$result = $program->execute(self::$env, function ($a, $b) {
