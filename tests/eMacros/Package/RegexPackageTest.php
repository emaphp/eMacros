...
class RegexPackageTest extends eMacrosTest {
	...
	public function testGrep1() {
		...
		$program = new SimpleProgram('(Regex::grep "/^(\\\d+)?\\\.\\\d+$/" (%0))');
	...
	public function testGrep2() {
		$input = array('abc', '45.23', '0x3F', '4.5', '%&(*)');
		$program = new SimpleProgram('(Regex::grep "/^(\\\d+)?\\\.\\\d+$/" (%0) Regex::GREP_INVERT)');
		$result = $program->execute(self::$env, $input);
	...
	public function testQuote1() {
		...
		$program = new SimpleProgram('(Regex::quote (%0))');
	...
	public function testSplit1() {
		...
		$program = new SimpleProgram('(Regex::split (%0) (%1))');
	...
	public function testSplit2() {
		$pattern = "//";
		$subject = "string";
		$program = new SimpleProgram('(Regex::split (%0) (%1) -1 Regex::SPLIT_NO_EMPTY)');
		$result = $program->execute(self::$env, $pattern, $subject);
	...
	public function testSplit3() {
		$pattern = "/ /";
		$subject = "hypertext language programming";
		$program = new SimpleProgram('(Regex::split (%0) (%1) -1 Regex::SPLIT_OFFSET_CAPTURE)');
		$result = $program->execute(self::$env, $pattern, $subject);
	...
	public function testMatch0() {
		$program = new SimpleProgram('(Regex::match)');
		$result = $program->execute(self::$env);
	}
	
	public function testMatch2() {
		$program = new SimpleProgram('(Regex::match "/([\\\d]{4})-([\\\d]{2})-([\\\d]{2})/" "2013-11-12")');
		$result = $program->execute(self::$env);
		$this->assertEquals(1, $result);
	}
	
	public function testMatch3() {
		$program = new SimpleProgram('(Regex::match "/([\\\d]{4})-([\\\d]{2})-([\\\d]{2})/" "2013-11-12" _matches)(<- _matches)');
		$result = $program->execute(self::$env);
		$this->assertEquals(array('2013-11-12', '2013', '11', '12'), $result);
	}
	
	public function testMatch4() {
		$program = new SimpleProgram('(Regex::match "/([\\\d]{4})-([\\\d]{2})-([\\\d]{2})/" "2013-11-12" _matches Regex::OFFSET_CAPTURE)(<- _matches)');
		$result = $program->execute(self::$env);
	...
	public function testAllMatches0() {
		$program = new SimpleProgram('(Regex::match-all)');
		$result = $program->execute(self::$env);
	}
	...
	public function testAllMatches1() {
		...
		$program = new SimpleProgram('(Regex::match-all (%0) (%1))');
		$result = $program->execute(self::$env, $pattern, $subject);
	...
	public function testAllMatches2() {
		$pattern = "|<[^>]+>(.*)</[^>]+>|U";
		$subject = "<b>example: </b><div align=left>this is a test</div>";
		$program = new SimpleProgram('(Regex::match-all (%0) (%1) _matches)(<- _matches)');
		$result = $program->execute(self::$env, $pattern, $subject);
	...
	public function testAllMatches3() {
		$pattern = "|<[^>]+>(.*)</[^>]+>|U";
		$subject = "<b>example: </b><div align=left>this is a test</div>";
		$program = new SimpleProgram('(Regex::match-all (%0) (%1) _matches Regex::PATTERN_ORDER)(<- _matches)');
		$result = $program->execute(self::$env, $pattern, $subject);
		$this->assertEquals(array(array('<b>example: </b>', '<div align=left>this is a test</div>'),
				array('example: ', 'this is a test')), $result);
	}
	...
	public function testAllMatches4() {
		$pattern = "|<[^>]+>(.*)</[^>]+>|U";
		$subject = "<b>example: </b><div align=left>this is a test</div>";
		$program = new SimpleProgram('(Regex::match-all (%0) (%1) _matches Regex::SET_ORDER)(<- _matches)');
		$result = $program->execute(self::$env, $pattern, $subject);
	...
	public function testReplace0() {
		$program = new SimpleProgram('(Regex::replace)');
		$result = $program->execute(self::$env);
	}
	...
	public function testReplace1() {
		...
		$pattern = '/(\w+) (\d+), (\d+)/i';
		$replacement = '${1}1,$3';
		$program = new SimpleProgram('(Regex::replace (%0) (%1) (%2))');
	...
	public function testReplaceCallback0() {
		$program = new SimpleProgram('(Regex::replace-callback)');
		$result = $program->execute(self::$env);
	}
	...
	public function testReplaceCallback1() {
		...
		$program = new SimpleProgram('(Regex::replace-callback (%0) null (%1))');
		$result = $program->execute(self::$env, $pattern, $subject);
	}
	...
	public function testReplaceCallback2() {
		...
		$program = new SimpleProgram('(Regex::replace-callback (%0) (%1) (%2))');
